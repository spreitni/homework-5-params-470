...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname |homework 9 11-2-21|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
;***** Environment Stuff *****
(define resolve
  (lambda (varName env)
    (cond
